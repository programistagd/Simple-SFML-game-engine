...
${OBJECTDIR}/LevelSwitch.o: LevelSwitch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../c++/SFML-2.1/include -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/LevelSwitch.o LevelSwitch.cpp
...
${OBJECTDIR}/TextSign.o: TextSign.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../c++/SFML-2.1/include -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TextSign.o TextSign.cpp
